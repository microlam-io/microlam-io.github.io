...
class fetchpub implements Callable<Integer> {
    ...
    public Integer call() throws Exception { // your business logic goes here...
        ...
        var ghRepo = github.getRepository("microlam-io/microlam");

        var list = github.searchIssues().isOpen().q("repo:microlam-io/microlam-io.github.io").q("label:publication").q("is:issue").list()
                .asList();
